...
function home(){
  window.document.title = 'Jonas Lima'
...
function curriculum(){
  window.document.title = 'Currículo - Jonas Lima'
        ...
        <div class="curriculum">
          ...
          <div class="content">
            ...
            <div class="right">
              ...
              <div class="download">
                <a href="./assets/curriculum.pdf" accesskey="d" title="Download" download="jonaslima-curriculo">Download <i class='bx bxs-download' ></i></a>
              </div>
            </div>
          </div>
...
function portfolio(){
  window.document.title = 'Portfólio - Jonas Lima'
...
function contacts(){
  window.document.title = 'Contatos - Jonas Lima'
  containerMain.innerHTML = `
    <div class="page-contacts">
      ...
      <div class="content">
        <div class="left">
          ...
          <div class="links">
            <a href="https://github.com/eujonas" accesskey="g" title="GitHub" target="_blank">
              <i class='bx bxl-github' ></i>
            </a>
            <a href="https://twitter.com/jonaslc_" accesskey="t" title="Twitter" target="_blank">
              <i class='bx bxl-twitter' ></i>
            </a>
            <a href="https://www.instagram.com/jonaslc_" accesskey="i" title="Instagram" target="_blank">
